...
assert.match(runtime,/production-mode-v1\.js\?v=20260911\.verified1/,'runtime must load the observer-free production mode cache key');
assert.match(index,/app-runtime-v1\.js\?v=20260911\.verified1/,'index must bust app-runtime cache');
