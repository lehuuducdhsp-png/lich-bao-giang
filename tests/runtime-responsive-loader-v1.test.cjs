...
assert.match(index,/ga-role-track-stale-repair-v1\.js\?v=20260919\.2/,'STEM/KNS stale GA repair must stay loaded');
assert.ok(index.indexOf('ga-group-split-stale-repair-v1.js?v=20260914.1')<index.indexOf('ga-role-track-stale-repair-v1.js?v=20260919.2'),'role-track repair must run after group-split repair');
assert.ok(index.indexOf('ga-role-track-stale-repair-v1.js?v=20260919.2')<index.indexOf('ga-multi-selection-bridge-v1.js?v=20260914.2'),'role-track repair must run before the shared multi-GA bridge');
