...
assert.ok(index.indexOf('tkb-roster-group-period-safe-v1.js?v=20260918.1')<index.indexOf('tkb-assignment-cache-safe-v1.js?v=20260913.1'),'roster group period safety must load before assignment cache');
