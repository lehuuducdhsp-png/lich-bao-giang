...
assert.match(per,/const VERSION='20260920\.2'/);
...
assert.match(index,/ga-per-class-v2\.js\?v=20260920\.2/);
assert.match(index,/ga-multi-selection-bridge-v1\.js\?v=20260914\.2/);
assert.ok(index.indexOf('ga-per-class-v2.js?v=20260920.2')<index.indexOf('ga-multi-selection-bridge-v1.js?v=20260914.2'),'stable bridge must load after per-class GA');
...
for(const required of [
  ...
  'ga-per-class-v2.js?v=20260920.2',
