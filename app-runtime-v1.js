...
(function(){
  ...
  (async()=>{
    try{
      ...
      await add('ga-suggestion-cross-version-v1.js?v=20260912.2','lbgGaSuggestionCrossVersionV1Script');
      ...
      const modules=[
        ...
        ['production-mode-v1.js?v=20260909.4','lbgProductionModeV1Script'],
